...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for ghostPosition in maxLikelyGhostPositions:
        ...
        for action in legal:
            ...
            actionDistance = self.distancer.getDistance(nextPosition, closestGhost)
            if actionDistance < minActionDistance:
                bestAction = action
                minActionDistance = actionDistance
